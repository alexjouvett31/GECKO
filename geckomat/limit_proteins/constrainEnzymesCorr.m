%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% [model,enzUsages,modifications,MW,counter] = constrainEnzymesCorr(model,Ptot,sigma,f,pIDs,data,MW,counter)
...
function [model,enzUsages,modifications,MW,counter] = constrainEnzymesCorr(model,Ptot,sigma,f,pIDs,data,MW,counter)
...
model_batch.ub(loc(j)) = 1.25*mass_fracs(j)*total_protein_mass*sigma./model_batch.MWs(loc2);
model_batch.lb(loc(j)) = 0.75*mass_fracs(j)*total_protein_mass*sigma./model_batch.MWs(loc2);
